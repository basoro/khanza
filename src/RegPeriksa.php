...
class RegPeriksa
{
    ...
    public function Data()
    {
        ...
        $query .= "reg_periksa.kd_dokter,dokter.nm_dokter,reg_periksa.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.no_ktp,pasien.no_peserta,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur,poliklinik.nm_poli, ";
